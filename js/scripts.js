      ...
      u(".nav li a").on("click", function (e) {
        ...
        if (
          ...
          (!t.closest(".dropdown").hasClass("open") ||
            "block" === t.closest(".dropdown-menu").css("display") ||
        ...
        void 0 !== window.Waypoint &&
          new Waypoint.Sticky({ element: u(".nav-section"), offset: -1 }),
      ...
      this.heroFullScreen &&
        ...
        u(window).resize(function () {
          ...
          t < 0 && !Number.isNaN(t) && (a += t + e),
            ...
            0 < n &&
              u(".v-center").length &&
              u("#hero >.container").css({ "margin-top": n / 2 + o + "px" }),
            u("#hero").css({ minHeight: u(window).innerHeight() + "px" });
        }));
    },
              ...
              o = function (e) {
                var t = e.latitude,
                  ...
                  i = new RichMarker({
                    ...
                    shadow: "none",
                    content:
                      '<div class="marker"><i class="fa ' + n + '"></i></div>',
                  });
    ...
    countdown: function () {
      ...
      u(".countdown").length &&
        ((o = function (e, t, a) {
          ...
          if (o < 0)
            return (
              t.html('<div class="end">' + i.countdownEndMsg + "</div>"),
              clearInterval(e),
              !1
            );
          ...
          s.each(function () {
            ...
            "hidden" === e.attr("type")
              ? e.hasClass("subject")
                ...
                ? (c += "&fromemail=" + n(e.val()))
                : (e.hasClass("emailTo") || e.hasClass("emailto")) &&
                  (c += "&emailto=" + n(e.val()))
              : ("checkbox" === e.attr("type") &&
                ...
                (e.is("fieldset") &&
                e.hasClass("required") &&
                0 === u("#" + e.attr("id") + " input:checkbox:checked").length
                  ...
                  : "g-recaptcha-response" !== e.attr("id") &&
                    ...
                    e.hasClass("subject")
                      ? ((c += "&subject=" + n(e.val())),
                        (c += "&subject_label=" + n(e.attr("name"))))
                      : e.hasClass("fromName") || e.hasClass("fromname")
                      ? ((c += "&fromname=" + n(e.val())),
                        (c += "&fromname_label=" + n(e.attr("name"))))
                      : e.hasClass("fromEmail") || e.hasClass("fromemail")
                      ? ((c += "&fromemail=" + n(e.val())),
                        (c += "&fromemail_label=" + n(e.attr("name"))))
                      : ("radio" === e.attr("type")
                          ? u("input[id='" + e.attr("id") + "']").is(
                              ":checked"
                            ) &&
                            ((c +=
                              "&field" + r + "_label=" + n(e.attr("name"))),
                            (c +=
                              "&field" +
                              r +
                              "_value=" +
                          ...
                          ? ((c +=
                              "&field" + r + "_label=" + n(e.attr("name"))),
                            u(
                              "#" + e.attr("id") + " input:checkbox:checked"
                            ).each(function (e) {
                              0 === e
                                ? ((c += "&field" + r + "_value="),
                                  (c += n(
      ...
      u(".btn").each(function () {
        ...
        u("#about-us .element .image").on("mouseenter", function () {
          ...
          if (
            ...
            !u(">.divider-about-us", e.closest(".row")).hasClass("flip")
          )
            return !1;
          e.hasClass("flip") ||
      ...
      this.timelineParallax &&
        ((i = function (n) {
          u("> div", this).each(function () {
            ...
            e.css({
              "-webkit-transform":
                "translateX(" + a + "px) translateY(" + t + "px)",
              "-moz-transform":
                "translateX(" + a + "px) translateY(" + t + "px)",
              "-ms-transform":
                "translateX(" + a + "px) translateY(" + t + "px)",
